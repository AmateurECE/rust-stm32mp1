...
pub fn hsem_fasttake(hsem: &stm32mp157::HSEM, id: u32) -> Result<(), AlreadyLocked> {
...
pub fn hsem_release(hsem: &stm32mp157::HSEM, id: u32) {
    match id {
        0 => hsem
            .hsem_r0
...
pub fn gpio_init_h7(gpioh: &stm32mp157::GPIOH) {
...
pub fn gpio_init_a14(gpioa: &stm32mp157::GPIOA) {
...
pub fn exti_set_config_line(exti: &stm32mp157::EXTI) {
